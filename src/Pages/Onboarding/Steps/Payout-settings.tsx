...
const PayoutSettings = () => {
    ...
    const handleGetTransactionFeesResponse = (
        getTransactionsFeesResponse: TransactionsFeesResponseInterface,
        id: string,
    ): void => {
        if (tequilApiResponseHandler(history, getTransactionsFeesResponse)) {
            registerIdentity(
                ...
                values.stake,
                getTransactionsFeesResponse.transactorFeesResponse.registration,
            ).then((response) => {
