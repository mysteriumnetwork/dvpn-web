...
export const DEFAULT_PRICE_PER_MINUTE_PRICE = 0.005;
export const DEFAULT_PRICE_PER_GB = 0.005;
...
export const NEW_PASSWORD_ERROR_NOT_SAME = "Passwords have to match.";
